...
### [我的博客在这里](http://codeclub.bid/blog/)

### [模板在这里](http://codeclub.bid/blog/)

我的博客仓库——`https://github.com/jacksoncode/blog`，是经常修改的。大家可以直接fork模板——`huxblog-boilerplate`,要改的地方我都说明了。或者可以直接下载zip到本地自己去修改。
